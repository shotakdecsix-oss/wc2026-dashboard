...
"""
    ...
    prompts = {
        ...
        'bracketPrediction': (
            context
            + "\n## タスク\n"
            "グループ予想に基づき、WC2026ノックアウトトーナメントの勝敗予想をJSONで出力してください。\n\n"
            "【公式R32組み合わせ枠（FIFA確定）】以下の枠に上記グループ予想の実チーム名を当てはめてください。\n"
            "M73:2位A vs 2位B / M74:1位E vs 3位(A・B・C・D・Fのいずれかの最上位3位) / M75:1位F vs 2位C / M76:1位C vs 2位F\n"
            "M77:1位I vs 3位(C・D・F・G・Hのいずれかの最上位3位) / M78:2位E vs 2位I / M79:1位A vs 3位(C・E・F・H・Iのいずれかの最上位3位)\n"
            "M80:1位L vs 3位(E・H・I・J・Kのいずれかの最上位3位) / M81:1位D vs 3位(B・E・F・I・Jのいずれかの最上位3位) / M82:1位G vs 3位(A・E・H・I・Jのいずれかの最上位3位)\n"
            "M83:2位K vs 2位L / M84:1位H vs 2位J / M85:1位B vs 3位(E・F・G・I・Jのいずれかの最上位3位)\n"
            "M86:1位J vs 2位H / M87:1位K vs 3位(D・E・I・J・Lのいずれかの最上位3位) / M88:2位D vs 2位G\n\n"
            "R16組み合わせ: M89=M74勝vsM77勝, M90=M73勝vsM75勝, M91=M76勝vsM78勝, M92=M79勝vsM80勝,\n"
            "M93=M83勝vsM84勝, M94=M81勝vsM82勝, M95=M86勝vsM88勝, M96=M85勝vsM87勝\n"
            "QF: M97=M89勝vsM90勝, M98=M93勝vsM94勝, M99=M91勝vsM92勝, M100=M95勝vsM96勝\n"
            "SF: M101=M97勝vsM98勝, M102=M99勝vsM100勝\n\n"
            "以下の構造のJSONのみ出力（マークダウン・コードブロック・説明文は一切不要）：\n\n"
            '{"r32":[{"home":"実チーム名","away":"実チーム名","winner":"実チーム名"},...],' "\n"
            '"r16":[...8試合...],"qf":[...4試合...],"sf":[...2試合...],' "\n"
            '"final":{"home":"X","away":"Y","winner":"X"},' "\n"
            '"third":{"home":"P","away":"Q","winner":"P"},' "\n"
            '"champion":"X"}' "\n\n"
            "ルール：\n"
            "- r32はM73〜M88の順に16試合（home/away/winner 必須）\n"
            "- r16は8試合、qfは4試合、sfは2試合、finalは1試合\n"
            "- winnerは必ずhomeかawayのチーム名と完全一致\n"
            "- チーム名は日本語で統一\n"
            "- JSONのみ出力、前後に何も書かない"
        ),
        'tacticalTrend': (
