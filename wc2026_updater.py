...
"""
    ...
    prompts = {
        ...
        'bracketPrediction': (
            ...
            "【公式R32組み合わせ枠（FIFA確定）】以下の枠に実チーム名を当てはめてください：\n"
            "M73:2位A vs 2位B / M74:1位E vs 3位(A-D-F) / M75:1位F vs 2位C / M76:1位C vs 2位F\n"
            "M77:1位I vs 3位(C-D-F-G-H) / M78:2位E vs 2位I / M79:1位A vs 3位(C-E-F-H-I)\n"
            "M80:1位L vs 3位(E-H-I-J-K) / M81:1位D vs 3位(B-E-F-I-J) / M82:1位G vs 3位(A-E-H-I-J)\n"
            "M83:2位K vs 2位L / M84:1位H vs 2位J / M85:1位B vs 3位(E-F-G-I-J)\n"
            "M86:1位J vs 2位H / M87:1位K vs 3位(D-E-I-J-L) / M88:2位D vs 2位G\n\n"
            "R16組み合わせ（参考）：M89=M74勝vM77勝, M90=M73勝vM75勝, M91=M76勝vM78勝, M92=M79勝vM80勝\n"
            "M93=M83勝vM84勝, M94=M81勝vM82勝, M95=M86勝vM88勝, M96=M85勝vM87勝\n"
            "QF：M97=M89勝vM90勝, M98=M93勝vM94勝, M99=M91勝vM92勝, M100=M95勝vM96勝\n"
            "SF：M101=M97勝vM98勝, M102=M99勝vM100勝\n\n"
            "以下の構造のJSONのみ出力（マークダウン・説明文不要）：\n\n"
            '{"r32":[{"home":"チームA","away":"チームB","winner":"チームA"},...],' "\n"
            '"r16_w":["M89勝者","M90勝者","M91勝者","M92勝者","M93勝者","M94勝者","M95勝者","M96勝者"],' "\n"
            '"qf_w":["M97勝者","M98勝者","M99勝者","M100勝者"],' "\n"
            '"sf_w":["M101勝者","M102勝者"],' "\n"
            '"champion":"優勝チーム","third":"3位チーム"}' "\n\n"
            "ルール：\n"
